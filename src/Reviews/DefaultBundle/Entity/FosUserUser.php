...
class FosUserUser
{
     ...
     * Add group
     *
     * @param \Reviews\DefaultBundle\Entity\FosUserGroup $group
     *
     * @return FosUserUser
     */
    public function addGroup(\Reviews\DefaultBundle\Entity\FosUserGroup $group)
    {
        $this->group[] = $group;
     ...
     * @param \Reviews\DefaultBundle\Entity\FosUserGroup $group
     */
    public function removeGroup(\Reviews\DefaultBundle\Entity\FosUserGroup $group)
    {
